...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | ArtIn3D - Get in Touch for 3D Projects</title>
        <meta 
          name="description" 
          content="Contact ArtIn3D for professional 3D modeling, animation, and visualization services. Let's bring your creative ideas to life with stunning 3D designs." 
        />
        <meta 
          name="keywords" 
          content="contact 3D artist, hire 3D designer, 3D modeling services, 3D animation contact, architectural visualization, ArtIn3D contact" 
        />
        <link rel="canonical" href="https://artin3d.fun/contact" />
      </Helmet>
