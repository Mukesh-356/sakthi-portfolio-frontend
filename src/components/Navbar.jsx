...
//   return (
//     <nav ref={navRef} className="glass-effect fixed w-full z-50">
...
//               to="/projects"
//               className={`hover:text-blue-400 transition-colors ${
//                 location.pathname === '/projects' ? 'text-blue-400' : 'text-white'
//               }`}
//             >
//               Projects
//             </Link>
...
//                   isLinksOpen ? 'text-blue-400' : 'text-white'
//                 }`}
//               >
//                 <span>Links</span>
//               </button>
...
//               {isLinksOpen && (
//                 <div className="absolute top-full left-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-50">
